	...
	namespace CommonTools
	{
		...
		*/
		...
		//! Calculate mean and std
                void GetStatistics( vnl_vector<double>& v, double& mean, double& std );

                
		//! Calculate surface-to-surface errors and return 2 shapes with corresponding arrays
                void GetS2S(vtkPolyData *shapePt1, vtkPolyData *shapePt2, vtkPolyData *outShape1, 
                            vtkPolyData* outShape2, double& mean, double& stdev, double& maximum );
