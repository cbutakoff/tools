...
nsi_cvg = pd.read_csv(nsi_cvg_file, comment='#', header=None, index_col=0, delim_whitespace=True)
...
axes[0].plot(nsi_cvg.index, nsi_cvg[15], label='Momentum')
axes[0].plot(nsi_cvg.index, nsi_cvg[16], label='Continuity')
...
fig1, axes = plt.subplots(n, m) #, figsize=(20,5*n))
